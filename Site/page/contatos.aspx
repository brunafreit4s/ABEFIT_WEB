...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div id="TextoContato">
        ...
        <br />
        <br />
        <asp:TextBox runat="server" ID="txtMensagem" Height="250px" Width="550px"
        ...
        <br />
        <br />
            <asp:Button runat="server" ID="EnviaContato" BackColor="#009999"
            BorderColor="#006666" Font-Bold="True" Font-Italic="False" ForeColor="White"
            Height="43px" Text="Enviar" Width="95px" OnClick="EnviaContato_Click" />
            <asp:Button runat="server" ID="EnviaContatoAluno" BackColor="#009999"
            BorderColor="#006666" Font-Bold="True" Font-Italic="False" ForeColor="White"
            Height="43px" Text="Enviar" Width="95px" OnClick="EnviaContatoAluno_Click" Visible="False" />
