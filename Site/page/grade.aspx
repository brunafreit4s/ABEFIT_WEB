<%@ Page Title="" Language="C#" MasterPageFile="~/page/MasterPage.master" AutoEventWireup="true"
    CodeFile="grade.aspx.cs" Inherits="page_grade" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="datagrid">
        ...
        <asp:SqlDataSource ID="SqlDataSource4" runat="server" ConnectionString="<%$ ConnectionStrings:ABEFITConnectionString %>" SelectCommand="SELECT H.Horarios, H.Dia_Semana, M.Modalidade FROM Horario AS H INNER JOIN Horario_Modalidade AS HM ON H.IdHorario = HM.IdHorario INNER JOIN Modalidade AS M ON HM.IdModalidade = M.IdModalidade where 
m.idmodalidade =@mod and h.dia_semana like @dia" OnSelecting="SqlDataSource4_Selecting">
            <SelectParameters>
