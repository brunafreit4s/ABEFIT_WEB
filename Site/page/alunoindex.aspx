...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div id="textoAluno">
        <br />
        <asp:Label runat="server" Text="Seja Bem vindo(a)" Font-Size="Large"
        ForeColor="#009999" Width="150px" Height="25px">
        </asp:Label>
        ...
        <asp:Label runat="server" Text="Gostaria de Alterar sua senha?:" Font-Italic="False"
        Font-Size="Large" ForeColor="#009999" Height="25px">
        </asp:Label>
        <br />
        <br />

        <asp:RadioButton runat="server" Text="Sim" ID="simaluno" AutoPostBack="True"
        OnCheckedChanged="simaluno_CheckedChanged" Font-Size="Large"
        ForeColor="#009999" Height="25px" Width="65px" />
        <br />
        <br />
        ...
        <div id="FormSenha">
            ...
            ErrorMessage="Digite a senha anterior!"
